...
#The 500mV image
img.500mV <- img_2_arr(source.png = 'm1_Z RetraceDown Tue Jan 24 14.08.14 2023 [6-3] _0.5V_100pA.png', x.lim = c(0, 6.115), y.lim = c(0, 6.115))
save(img.500mV, file = 'STM_img_Jan24_14.08.14_2023_[6-3] _0.5V_100pA.rda')
